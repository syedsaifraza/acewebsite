            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  ...
                  />
                  <Image
                    src="/images/logo/ace-logo-dark.png"
                    alt="logo"
                ...
                Acetians Technologies Pvt Ltd is one of the most reliable companies offering B2B Consulting, Implementation Services on Cloud Computing, Big Data Hadoop&Salesforce, Cloud Services, IT Security Solutions, IT Storage solutions, Data Center Solutions and Corporate trainings across the nation.
                </p>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <a
                      ...
                      className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                    >
                      LAJJPAT NAGAR, Lajpat Nagar Road, Kanpur, Kanpur Nagar, Uttar Pradesh, 208005
                    </a>
                  </li>
