...
const IndustriesHealthcarePage = () => {
  return (
    <>
      <Breadcrumb
        pageName="Industries / Healthcare"
        description="Our services aimed at promoting, maintaining, and restoring health for individuals and communities."
      />
   <TechnologyServices
...
export default IndustriesHealthcarePage;
