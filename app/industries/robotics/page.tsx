...
const IndustriesRoboticsPage = () => {
  return (
    <>
      <Breadcrumb
        pageName="Industries / Robotics"
        description="Impacting design, construction, programming, and operation of robots. "
      />
   <TechnologyServices
...
export default IndustriesRoboticsPage;
